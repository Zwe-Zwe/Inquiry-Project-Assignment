    ...
    <article id="enquiry-article">     
      ...
      <h1>Enquiry Service Form</h1>
            ...
            <tr>
              ...
              <td>
                <select id="service" name="service" required>
                  ...
                  <option value="sewing_alteration">Sewing and Alteration</option>
                </select>
              </td>
            </tr>
            <tr>
              <td colspan="2">
                <p id="contact-method_text">Please check your preferred contact-methods:</p>
                <div class="contact-method">
                  <label><input type="checkbox" name="contact_method" value="phone"> Phone Call</label>
                  <label><input type="checkbox" name="contact_method" value="email"> Email</label>
                  <label><input type="checkbox" name="contact_method" value="text"> Text Message</label>
                </div>
              </td>
            </tr>      
          </table>
        ...
        <fieldset>
          ...
          <table>
            <tr>
              ...
              <td><input type="radio" id="online" name="appointment_option" value="online"></td>
            </tr>
            <tr>
              <td><label for="onsite">Onsite:</label><br></td>
              <td><input type="radio" id="onsite" name="appointment_option" value="onsite"></td>
            </tr>
            <tr>
        ...
        <section id="btnSection">
          ...
          <p id="required_warning">*All the fields are required to be filled.</p>
        </section>
      </form>
    </article>
